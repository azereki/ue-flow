/**
 * T3D paste text fixtures for parser tests.
 * Ported from Python test suites for cross-language parity validation.
 */

/** Single Event node with exec output + delegate pin (from test_t3d_parser.py) */
export const EVENT_NODE_T3D = `\
...
/** CallFunction node with exec pins + string data pin (from test_t3d_parser.py) */
export const CALL_FUNCTION_NODE_T3D = `\
...
/** 3-node graph: Event -> Branch -> PrintString (from test_parity.py) */
export const MULTI_NODE_T3D = `\
Begin Object Class=/Script/BlueprintGraph.K2Node_Event Name="K2Node_Event_0"
   EventReference=(MemberParent="/Script/Engine.Actor",MemberName="ReceiveBeginPlay")
   NodePosX=0
   NodePosY=0
